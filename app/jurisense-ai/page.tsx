...
export default function JuriSenseAI() {
  ...
  return (
    <PageTransition className="min-h-screen bg-aurora-primary transition-colors duration-300">
      <Navigation />
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <div className="text-lg text-aurora-text/80 max-w-2xl mx-auto">
              <TypingEffect 
          ...
          <motion.div
            ...
            className="bg-aurora-secondary rounded-2xl shadow-lg border border-aurora-accent1/20 h-[600px] flex flex-col"
          >
            {/* Messages */}
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
                    ...
                    <div
                      className={`max-w-[80%] p-4 rounded-2xl ${
                        message.type === 'user'
                          ...
                          : 'bg-aurora-primary text-aurora-text'
                      }`}
                    >
                      <p className="text-sm leading-relaxed">{message.content}</p>
                      <p className={`text-xs mt-2 ${
                        message.type === 'user' ? 'text-aurora-primary/70' : 'text-aurora-text/60'
                      }`}>
              ...
              {isLoading && (
                ...
                >
                  ...
                  <div className="bg-aurora-primary p-4 rounded-2xl">
            ...
            {/* Input */}
            <div className="p-6 border-t border-aurora-accent1/20">
              <form onSubmit={handleSendMessage} className="flex gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-aurora-primary text-aurora-text border border-aurora-accent1/30 rounded-xl focus:ring-2 focus:ring-aurora-accent1 focus:border-transparent transition-all"
                  disabled={isLoading}
                />
                <motion.button
                  type="submit"
