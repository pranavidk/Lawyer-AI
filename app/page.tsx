...
import { AuroraSplashScreen } from '@/components/AuroraSplashScreen'
...
export default function Home() {
  ...
  return (
    <PageTransition className="min-h-screen bg-aurora-primary transition-colors duration-300">
      {showSplash && <AuroraSplashScreen onComplete={handleSplashComplete} />}
      <Navigation />
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold text-aurora-text mb-6 leading-[1.1]">
              JuriSense
              <span className="block bg-gradient-to-r from-aurora-accent1 to-aurora-accent2 bg-clip-text text-transparent leading-[1.1]">
                AI Legal Assistant
              </span>
            </h1>
            <div className="text-xl text-aurora-text/80 max-w-3xl mx-auto mb-8 leading-relaxed">
              <TypingEffect 
