    ...
    <AnimatePresence>
      {isVisible && (
        <>
          ...
          >
            <div className="dark:bg-aurora-secondary light:bg-white rounded-2xl shadow-2xl border dark:border-aurora-accent1/20 light:border-gray-200 p-4">
              {!isMinimized ? (
                <>
                  <div className="flex items-start gap-3">
                    <AlertTriangle className="h-6 w-6 text-amber-500 mt-0.5 flex-shrink-0" />
                    <div className="flex-1">
                      <h3 className="font-semibold dark:text-aurora-text light:text-light-text mb-2">
                        ⚠️ Not Legal Advice
                      </h3>
                      <p className="text-sm dark:text-aurora-text/80 light:text-light-text/80 leading-relaxed">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs dark:text-aurora-text light:text-light-text font-medium">
                    Not Legal Advice
                  </span>
                  <button
                    onClick={handleDismiss}
