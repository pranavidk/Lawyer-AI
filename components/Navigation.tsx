...
import { FileText, BookOpen, Shield, MessageCircle, Settings, Scale, User, Home } from 'lucide-react'
...
const navigation = [
  ...
  { name: 'Legal Summaries', href: '/legal-summaries', icon: FileText },
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="relative">
            <button
              ...
              className="p-2 text-aurora-text/80 hover:text-aurora-accent1 transition-colors rounded-lg hover:bg-aurora-secondary/50"
